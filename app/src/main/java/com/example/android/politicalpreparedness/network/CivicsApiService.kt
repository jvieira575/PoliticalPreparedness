...
interface CivicsApiService {
    ...
    @GET("voterinfo")
    suspend fun getVoterInformation(@Query("address") address: Address, @Query("electionId") electionId : Long, @Query("officialOnly") officialOnly : Boolean) : VoterInfoResponse
